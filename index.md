...
An additional but non-essential function within accessibletablesR is
readin_excel. This function allows the user to read in raw input data
tables that are either xlsx, xls or csv files.

filepath is the location and name of the raw input data table. sheetname
is the name of the sheet in the input file. colnames can be populated to
specify the desired final column names in the final output.
