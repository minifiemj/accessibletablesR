...
Create a contents page for the workbook.
...
contentstable function creates a table of contents for the workbook. If
no contents page wanted, then do not run the contentstable function.
gridlines is by default set to "Yes", change to "No" if gridlines are
