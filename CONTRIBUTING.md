# Contributing to accessibletablesR

This outlines how to propose a change to accessibletablesR. For a
...
Please report any typos, spelling mistakes or grammatical errors in the
documentation to the creator of accessibletablesR.
...
- Fork the package and clone onto your computer. If you haven’t done
  ...
  `usethis::create_from_github("minifiemj/accessibletablesR", fork = TRUE)`.
...
Please note that the accessibletablesR project is released with a
[Contributor Code of
Conduct](https://minifiemj.github.io/accessibletablesR/CODE_OF_CONDUCT.md).
By contributing to this project you agree to abide by its terms.

## Origin

This document is an amended version of the tidy contributing guide
